      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-all duration-500">
            ...
            {/* Booking Form */}
            <h3 className="text-2xl mb-4 text-center" style={{ color: '#074a6b' }}>Claim Your Session</h3>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button 
                type="submit"
                className="w-full py-4 rounded-lg text-white transition-all transform hover:scale-105"
