          ...
          >
            <div className="max-w-7xl mx-auto w-full">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  {/* Stage Badge */}
                  <div className={`inline-flex items-center gap-2 bg-blue-100 text-[#0080bf] px-4 py-2 rounded-full mb-6`}>
                  ...
                  <div className={`mt-6 bg-[rgb(208,239,255)] rounded-xl p-5`}>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className={`text-base text-[#0080bf] mt-1`}>{stage.benefit}</div>
                      </div>
                      <div>
                        <div className="text-sm text-gray-800">Starting at</div>
                        <div className={`text-base text-[#0080bf] mt-1`}>{stage.premium}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {stage.insurance.split(' • ').map((type, idx) => (
                      <span key={idx} className="bg-[rgb(208,239,255)] text-gray-800 px-3 py-1 rounded-full text-sm">
                        {type}
                      </span>
                    ))}
                  </div>
                  ...
                  {/* Learn More Link */}
                  {/* <button className="mt-8 inline-flex items-center gap-2 text-blue-600 hover:gap-3 transition-all">
