  ...
  return (
    <section className="py-24 relative overflow-hidden ">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative bg-[#f0f9ff] rounded-3xl overflow-hidden"
                ...
                >
                  ...
                  <div className="p-6 pb-4">
                    <div className="flex items-start justify-between mb-4 ">
                      <div 
                        className="p-3 rounded-xl bg-[rgb(208,239,255)]"
                    ...
                    <h3 className="text-2xl mb-1 text-[#074a6b]">
                      {layer.name}
                    </h3>
                    <p className=" text-gray-800">{layer.description}</p>
                  </div>
                  ...
                  <div className="px-6 py-3 border-t border-b border-gray-100">
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded-lg bg-[rgb(208,239,255)]">
                        <layer.stat.icon className="w-4 h-4 text-[#074a6b]" />
                      </div>
                      <div>
                        <span className="text-xl text-[#1a729e]">
                          {layer.stat.value}
                        </span>
                        <span className="text-xs text-gray-800 ml-1">{layer.stat.label}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 pt-4">
                    <div className="flex flex-wrap gap-2 mb-4">
                      {layer.solutions.map((sol) => (
                        <span 
                          key={sol} 
                          className="text-xs px-3 py-1.5 rounded-full bg-[rgb(208,239,255)] text-gray-800"
                        >
                          {sol}
                        </span>
                      ))}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p className="font-medium text-[#074a6b]" >
                        {layer.emotionalHook}
                      </p>
                    </div>
        ...
        >
          <div className="bg-[#f0f9ff] rounded-2xl p-6 border border-gray-100 transition-shadow">
            <div className="flex items-center gap-4">
              <div className="p-3 rounded-xl bg-blue-50">
                <Calendar className="w-6 h-6 text-[#1a729e]" />
              </div>
              <div>
                <div className="text-2xl text-[#1a729e]">Every 30 sec</div>
                <p className="text-sm text-gray-800">someone faces a financial crisis due to health issues</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#f0f9ff] rounded-2xl p-6 border border-gray-100 transition-shadow">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-2xl text-[#1a729e]">₹10L+</div>
                <p className="text-sm text-gray-800">average medical emergency cost in India</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#f0f9ff] rounded-2xl p-6 border border-gray-100 transition-shadow">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-2xl text-[#1a729e]">76%</div>
                <p className="text-sm text-gray-800">of Indians are underinsured</p>
              </div>
            </div>
          </div>
        </motion.div>
