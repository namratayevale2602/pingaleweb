    ...
    <section className="py-24 relative overflow-hidden bg-[#f0faff]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <div className="mb-24">
          ...
          >
            <h3 className="text-3xl text-gray-900 mb-4">How We Work</h3>
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute -top-3 left-6">
                      <div 
                        className="w-8 h-8 rounded-full flex items-center justify-center bg-[#0080bf] text-white text-sm"
                      >
                        {item.step}
                      </div>
                    </div>
        ...
        <div>
          <motion.div 
            ...
            className="text-center mb-12"
          >
            <h3 className="text-3xl text-gray-900 mb-4">Our Credentials</h3>
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute -top-2 -right-2">
                      <div 
                        className="px-3 py-1 rounded-full text-xs bg-[#0080bf] text-white shadow-lg"
                      >
                        {cert.badge}
                      </div>
                    </div>
                    ...
                    <h4 className="text-lg text-gray-900 mb-1 pr-16">{cert.name}</h4>
                    <p className="text-sm text-gray-800 mb-3">{cert.authority}</p>
