      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-[#0A4D6B] text-white py-4 rounded-xl hover:bg-[#2A9D8F] transition-all duration-300 flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            {offices.filter(o => o.id === selectedOffice).map(office => (
              <div key={office.id} className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h4 className="text-xl text-gray-900 mb-1">{office.city} Office</h4>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          ...
          <div className="bg-[#1a729e] rounded-2xl p-6 text-white">
            ...
            <h4 className="text-lg mb-2">Emergency Contact</h4>
            <p className="text-2xl mb-2">+91 98765 43210</p>
            <p className="text-sm opacity-90">24/7 for existing clients</p>
          </div>

          <div className="bg-[#1a729e] rounded-2xl p-6 text-white">
            <Globe className="w-8 h-8 mb-4 opacity-80" />
            <h4 className="text-lg mb-2">Email Us</h4>
            <p className="text-2xl mb-4">hello@finance.com</p>
        ...
        <div className="mb-20">
          <div className="text-center mb-10">
            <h3 className="text-3xl text-gray-900 mb-4">Stay Connected</h3>
