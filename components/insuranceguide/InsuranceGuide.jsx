                  ...
                  {tips.map((tip, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="text-sm text-gray-900">{tip.title}</h4>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <h3 className="text-xl text-gray-900 mb-6">Insurance Types Explained</h3>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl text-gray-900 mb-4">Insurance Glossary</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-[#074a6b] to-[#0080bf] rounded-3xl p-12 text-white">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl mb-4">Still unsure?</h2>
              ...
              <div className="flex flex-wrap gap-4">
                <button
                onClick={handleCall}
                 className="bg-white text-[#074a6b] px-6 py-3 rounded-full hover:shadow-lg transition inline-flex items-center gap-2">
                  <Phone className="w-4 h-4" />
                  Call an Advisor
                </button>
                <button 
                onClick={handleWhatsApp}
                className="border-2 border-white text-white px-6 py-3 rounded-full hover:bg-white hover:text-[#074a6b] transition inline-flex items-center gap-2">
